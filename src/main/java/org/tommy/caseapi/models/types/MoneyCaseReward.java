...
public class MoneyCaseReward extends CaseReward {
     ...
     */
    public MoneyCaseReward(int slot, double chance, ItemStack previewItemStack, double amount) {
        super(slot, chance, previewItemStack);
        this.amount = amount;
    }

    /**
     * Constructs a new {@code MoneyCaseReward} with the specified parameters, including a broadcast setting.
     *
     * @param slot The slot in which the reward is displayed.
     * @param chance The probability of winning this reward.
     * @param previewItemStack The item used as a preview in the case.
     ...
     * @param amount The amount of in-game currency granted upon winning.
     */
    public MoneyCaseReward(int slot, double chance, ItemStack previewItemStack, boolean withBroadcastMessage, double amount) {
